...
adminStore.updateMember = param => {
	return new Promise((resolve, reject) => {
		Vue.http.options.emulateJSON = true
		Vue.http.post('./service/getMembers.service.php?action=update', param)
			.then(res => {
				resolve(res.data)
			})
			.catch(err => {
...
adminStore.addMember = postData => {
	...
	return new Promise((resolve, reject) => {
		Vue.http.options.emulateJSON = true
		Vue.http.post('./service/addMember.service.php', postData)
			.then(res => {
				resolve(res)
			})
			.catch(err => {
...
adminStore.deleteBook = bookId => {
	return new Promise((resolve, reject) => {
		if(bookId){
			Vue.http.get('./service/getBooks.service.php?action=delete&bookId=' + bookId)
				.then(res => {
					resolve(res.data)
				})
				.catch(err=>{
...
adminStore.deleteMember = memberId => {
	return new Promise((resolve, reject) => {
		if(memberId){
			Vue.http.get('./service/getMembers.service.php?action=delete&memberId=' + memberId)
				.then(res=>{
					resolve(res.data)
				})
				.catch(err=>{
...
adminStore.fetchOrderList = () =>{
	return new Promise((resolve, reject) => {
		Vue.http.get('./service/order.php?action=fetchList')
			.then(res=>{
				resolve(res.data)
			})
			.catch(err=>{
...
adminStore.confirmOrder = orderId => {
	return new Promise((resolve, reject) => {
		Vue.http.get('./service/order.php?action=confirmOrder&orderId=' + orderId)
			.then(res=>{
				resolve(res.data)
			})
			.catch(err=>{
...
adminStore.cancelOrder = orderId => {
	return new Promise((resolve, reject) => {
		Vue.http.get('./service/order.php?action=cancelOrder&orderId=' + orderId)
			.then(res=>{
				resolve(res.data)
			})
			.catch(err=>{
