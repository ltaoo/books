<template>
  <div class="container">
    <el-row :gutter="20">
      <el-col :span="12">
        <el-input placeholder="请输入会员姓名或学号" icon="search" v-model="memberQuery" :on-icon-click="searchMember.bind(this, memberQuery)">
        </el-input>
        <MemberList :members="members" :choose="chooseMember" />
      </el-col>
      <el-col :span="12">
        <el-input placeholder="请输入书籍名或ISBN码" icon="search" v-model="bookQuery" :on-icon-click="searchBook.bind(this, bookQuery)">
        </el-input>
